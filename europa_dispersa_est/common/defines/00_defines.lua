...
NCountry = {
	...
	RESISTANCE_DECAY_WHEN_NO_GROWTH = 0.002,		-- Resistance will fall by this much each day if there is nothing increasing it ( no VPs and no spread from neighbors )
...
NBuildings = {
	...
	SABOTAGE_FACTORY_DAMAGE = 300.0,		-- How much damage takes a factory building in sabotage when state is occupied. Damage is mult by (1 + resistance strength), i.e. up to 2 x base value.
